...
def render_set(model_path, name, iteration, views, gaussians, pipeline, background, cam_type):
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        ...
        rendering = render(view, gaussians, pipeline, background, cam_type=cam_type, stage="test")["render"]
...
def render_sets(dataset: ModelParams, hyperparam, iteration: int, pipeline: PipelineParams, skip_train: bool,
    ...
    with torch.no_grad():
        ...
        if hasattr(gaussians, 'motion_predictor') and gaussians.motion_predictor is not None:
