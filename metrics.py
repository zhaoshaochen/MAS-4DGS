...
def readImages(renders_dir, gt_dir):
    ...
    for fname in os.listdir(renders_dir):
        ...
        if render_path.suffix.lower() not in valid_extensions:
            continue
        ...
        try:
            ...
            print(f"Warning: Failed to load image {fname}: {e}")
            continue
        ...
        try:
            ...
            for method in os.listdir(test_dir):
                ...
                if not gt_dir.exists() or not renders_dir.exists():
                    print(f"Warning: Missing gt or renders directory for method {method}, skipping...")
                    continue
                ...
                # 检查是否成功读取了图像
                if len(renders) == 0:
                    print(f"Warning: No valid images found for method {method}, skipping...")
                    continue
